...
#   timestamp: 2025-06-28T15:10:23+00:00
...
class CertificateParameters(BaseModel):
    PolicyNo: str = Field(..., description='PolicyNo', examples=['PolicyNo'])
    Val: str = Field(
        ...,
        description='Enter Value',
        examples=[
            'Please enter EngineNumber and ChasisNumber for motor cases and MobileNumber for health cases'
        ],
    )
    Verification: str = Field(
        ...,
        description='Verification Field',
        examples=['EngineNumber,ChasisNumber, MobileNumber'],
    )
...
class GicerCertificatePostRequest(BaseModel):
    certificateParameters: Optional[CertificateParameters] = None
    consentArtifact: Optional[ConsentArtifactSchema] = None
    format: Format = Field(
        ..., description='The format of the certificate in response.'
...
class GicerCertificatePostResponse(BaseModel):
...
class GicerCertificatePostResponse1(BaseModel):
...
class GicerCertificatePostResponse2(BaseModel):
...
class GicerCertificatePostResponse3(BaseModel):
...
class GicerCertificatePostResponse4(BaseModel):
...
class GicerCertificatePostResponse5(BaseModel):
...
class GicerCertificatePostResponse6(BaseModel):
